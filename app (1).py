...
if page == "Home":
    ...
    st.image("https://images.pexels.com/photos/4167540/pexels-photo-4167540.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2", caption="Comprehensive health services for schools", use_container_width=True)
    st.markdown("""
    ...
    st.image("https://images.pexels.com/photos/4167543/pexels-photo-4167543.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2", caption="Partner with us to create a healthier school environment", use_container_width=True)
